...
use \Neomerx\Database\Migrations\V1\MigrateAspects;
use \Neomerx\Database\Migrations\V1\MigrateRegions;
use \Neomerx\Database\Migrations\V1\MigrateCarriers;
use \Neomerx\Database\Migrations\V1\MigrateFeatures;
...
use \Neomerx\Database\Migrations\V1\MigrateBaseProducts;
...
use \Neomerx\Database\Migrations\V1\MigrateFeatureValues;
...
use \Neomerx\Database\Migrations\V1\MigrateFeatureProperties;
...
use \Neomerx\Database\Migrations\V1\MigrateBaseProductProperties;
...
use \Neomerx\Database\Migrations\V1\MigrateFeatureValueProperties;
...
class MigrateCore
{
    ...
    public static function up()
    {
        ...
        MigrateFeatures::up();
        MigrateFeatureProperties::up();
        MigrateFeatureValues::up();
        MigrateFeatureValueProperties::up();
        MigrateAspects::up();
    ...
    public static function down()
    {
        ...
        MigrateAspects::down();
        MigrateFeatureValueProperties::down();
        MigrateFeatureValues::down();
        MigrateFeatureProperties::down();
        MigrateFeatures::down();
        MigrateMeasurementProperties::down();
        MigrateMeasurements::down();
        MigrateInventory::down();
        MigrateWarehouses::down();
        MigrateStores::down();
        MigrateBaseProductProperties::down();
