...
class MigrateTaxRules extends BaseMigrate
{
    /**
     * @var Model
     */
    ...
    public static function up()
    {
        Schema::create(Model::TABLE_NAME, function (Blueprint $table) {
            ...
            $table->unsignedInteger(Model::FIELD_ID_TAX);
            $table->string(Model::FIELD_NAME, Model::NAME_MAX_LENGTH);
            $table->unsignedInteger(Model::FIELD_PRIORITY);
            ...
            $table->foreign(Model::FIELD_ID_TAX)->references(Tax::FIELD_ID)->on(Tax::TABLE_NAME);
        });
    }
